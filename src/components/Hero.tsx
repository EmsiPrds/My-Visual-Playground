...
import { AnimatedThemeToggler } from "./animation-components/ThemeToggler";
...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center bg-primary dark:bg-white"
    >
      <div className="relative w-[98vw] max-w-screen h-[97vh] rounded-4xl flex flex-col items-center justify-center overflow-hidden bg-white dark:bg-primary shadow-2xl">
        {/* Top notch */}
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-70 h-25 bg-primary dark:bg-white clip-notch" />

        {/* Background glow */}
        <div
          className="absolute w-300 h-300 bg-yellow-400/30 rounded-full blur-3xl animate-pulse -bottom-100"
          style={{
        ...
        <div className="relative h-[650px] text-center space-y-8 animate-fadeIn z-10">
          <h1
            className={`text-4xl sm:text-4xl lg:text-5xl font-bakbak font-bold leading-tight tracking-wider text-gray-900 dark:text-white `}
          >
          ...
          <p
            className={`font-poppins text-lg sm:text-xl max-w-3xl mx-auto text-white dark:text-white`}
          >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 ">
            ...
            <button
              ...
              className={`px-8 py-2 rounded-full font-semibold border-2 border-yellow-500 text-yellow-600 dark:hover:bg-yellow-50 dark:border-secondary dark:text-secondary hover:bg-yellow-400/10  transition-colors duration-300`}
            >
              Let's Connect
            </button>
            <div>
